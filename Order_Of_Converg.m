...
% function [error_n, error_n1, x_regression, y_regression] = bisection_converg()
% 
%     error_n = [];
%     error_n1 = [];
...
% function [error_n, error_n1, x_regression, y_regression] = newton_converg()
% 
%     error_n = [];
%     error_n1 = [];
% 
...
function [error_n, error_n1, x_regression, y_regression] = secant_converg()
